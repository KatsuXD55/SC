...
return conn.sendMessage(m.chat, listMessage, { quoted: fkontak, mentions: await conn.parseMention(jarot), contextInfo:{ forwardingScore: 99999, isForwarded: true }}) 
 ...
 const fcon = {
    ...
    //------------------ DOCUMENT
let gh = 'https://github.com/KatsuXD55'
let buttonMessage= {
'document':{'url':gh},
'mimetype': 'application/pdf',
'fileName':'𝙱𝚘𝚝 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙 𝙱𝚢 Katsu',
'fileLength':'99999999999999',
'pageCount':'999',
'contextInfo':{
'externalAdReply':{
'showAdAttribution': true, 
'mediaUrl': 'https://instagram.com/katsubotz_official',
'title': '𝙱𝙾𝚃 𝙼𝚄𝙻𝚃𝙸 𝙳𝙴𝚅𝙸𝙲𝙴 𝙱𝚈 𝙹𝙰𝚁𝙾𝚃',
'body':'',
'mediaType': 2,
'thumbnail': fs.readFileSync('./thumbnail.jpg'),
'sourceUrl': 'https://instagram.com/katsubotz_official'}},
